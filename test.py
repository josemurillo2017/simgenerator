...
being_awesome = Event("Being Awesome", "YES!", ['Sexy'], "person.traits['Sexy']>10", "person.traits['Sexy'] +=10")
being_handsome = Event("Being Handsome", "YES!", ['Handsome'], "person.traits['Sexy']>10", "person.traits['Handsome'] +=10")
